 ...
 * Author: Andrew Owens
 *
 * This is a class for storing the curve geometry for an arc length parameterized curve
 * borrowed from the boilerplate code provided by Andrew Owens in CPSC 587.
 */
...
Curve::Curve(std::vector<Vec3f> points, bool isClosedCurve) : m_points(points), m_isClosedCurve(isClosedCurve) {}
